...
export const salaryStructureApi = {
  getAll: (params?: any) =>
    api
      .get("/salary-structures", {
        params: params, // Simple params without cache busting
      })
      .then((res) => {
        console.log("Salary Structures API Response:", res.data);
        return res.data;
  ...
  getByEmployeeId: (employeeId: string) =>
    api
      ...
      .then((res) => {
        console.log(
          `Salary Structure for Employee ${employeeId} API Response:`,
          res.data
        );
        return res.data;
      })
      .catch((error) => {
        console.error(
          `Salary Structure for Employee ${employeeId} API Error:`,
          error
        );
        throw error;
      }),
  ...
  deactivate: (id: string) =>
    api
      ...
      .then((res) => {
        console.log(
          `Deactivate Salary Structure ${id} API Response:`,
          res.data
        );
        return res.data;
      })
  ...
  getEmployeesWithoutStructure: (params?: any) =>
    api
      .get("/salary-structures/employees/without", {
        params: getCacheBustingParams(params),
        headers: {
          "Cache-Control": "no-cache, no-store, must-revalidate",
          Pragma: "no-cache",
...
export const payrollApi = {
  ...
  getByEmployeeAndMonth: (employeeId: string, month: string) =>
    api
      ...
      .then((res) => {
        console.log(
          `Payroll for ${employeeId} in ${month} API Response:`,
          res.data
        );
        return res.data;
      })
      .catch((error) => {
        console.error(
          `Payroll for ${employeeId} in ${month} API Error:`,
          error
        );
        throw error;
      }),
  ...
  bulkProcess: (data: any) =>
    api
      .post("/payroll/bulk-process", data, {
        headers: {
          "Cache-Control": "no-cache, no-store, must-revalidate",
          Pragma: "no-cache",
        },
  ...
  updatePaymentStatus: (id: string, data: any) =>
    api
      .put(`/payroll/${id}/payment-status`, data, {
        headers: {
          "Cache-Control": "no-cache, no-store, must-revalidate",
          Pragma: "no-cache",
        },
...
export const salarySlipApi = {
  getAll: (params?: any) =>
    api
      .get("/salary-slips", {
        params: params, // NO cache busting params
      })
      .then((res) => res.data)
      .catch((error) => {
        console.error("Salary Slips API Error:", error);
        throw error;
      }),
  ...
  getBySlipNumber: (slipNumber: string) =>
    api
      .get(`/salary-slips/slip/${slipNumber}`, {
        params: getCacheBustingParams(),
        headers: {
          "Cache-Control": "no-cache, no-store, must-revalidate",
          Pragma: "no-cache",
  ...
  getByEmployeeAndMonth: (employeeId: string, month: string) =>
    api
      .get(`/salary-slips/${employeeId}/${month}`, {
        params: getCacheBustingParams(),
        headers: {
          "Cache-Control": "no-cache, no-store, must-revalidate",
          Pragma: "no-cache",
      ...
      .then((res) => {
        console.log(
          `Salary Slip for ${employeeId} in ${month} API Response:`,
          res.data
        );
        return res.data;
      })
      .catch((error) => {
        console.error(
          `Salary Slip for ${employeeId} in ${month} API Error:`,
          error
        );
        throw error;
      }),
  ...
  markAsEmailed: (id: string) =>
    api
      ...
      .then((res) => {
        console.log(
          `Mark Salary Slip ${id} as Emailed API Response:`,
          res.data
        );
        return res.data;
      })
...
export const employeeApi = {
  ...
  getAttendance: (employeeId: string, month: string) =>
    api
      .get(`/attendance/${employeeId}/${month}`, {
        params: getCacheBustingParams(),
        headers: {
          "Cache-Control": "no-cache, no-store, must-revalidate",
          Pragma: "no-cache",
      ...
      .then((res) => {
        console.log(
          `Attendance for ${employeeId} in ${month} API Response:`,
          res.data
        );
        return res.data;
      })
      .catch((error) => {
        console.error(
          `Attendance for ${employeeId} in ${month} API Error:`,
          error
        );
        throw error;
      }),
  ...
  getLeaves: (employeeId: string, month: string) =>
    api
      ...
      .then((res) => {
        console.log(
          `Leaves for ${employeeId} in ${month} API Response:`,
          res.data
        );
        return res.data;
      })
...
export const apiDebug = {
  ...
  getCacheStatus: () => {
    console.log("API Cache Status:", {
      localStorage: localStorage.getItem("api-cache")
        ? "Has cache"
        : "No cache",
      sessionStorage: sessionStorage.getItem("api-cache")
        ? "Has cache"
        : "No cache",
    });
  },
  ...
  testConnection: () => {
    return api
      .get("/health", { params: getCacheBustingParams() })
      .then((res) => {
